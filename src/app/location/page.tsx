      ...
      <section className="py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="font-heading font-bold text-navy">주소</h2>
          ...
          {/* 구글맵 */}
          <div className="relative mt-8 overflow-hidden rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
            ...
            {transportInfo.map((info) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-heading font-bold text-navy">{info.title}</h3>
                </div>
