      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-white/70">
            ...
            최적화된 구조 솔루션을 제공하는{" "}
            <span className="text-gold font-semibold">(주)동양구조</span>
            입니다.
          </p>
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              href="/business"
              className="inline-flex h-9 items-center justify-center gap-1.5 rounded-lg bg-gold px-4 text-sm font-medium text-white transition-colors hover:bg-gold-dark"
            >
              사업분야 보기
